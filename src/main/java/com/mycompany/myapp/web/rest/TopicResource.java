...
public class TopicResource {
    ...
    public ResponseEntity<Topic> updateTopic(@PathVariable(value = "id", required = false) final String id, @RequestBody Topic topic)
        ...
        topic.setIsPersisted();
        Topic result = topicRepository.save(topic);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, topic.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Topic> partialUpdateTopic(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, topic.getId()));
    }
